...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    plhs[1] = mxCreateStructMatrix(1, 1, nfields, fnames);

    mxArray *fout;

    // Connectivity
    mxSetFieldByNumber(plhs[1], 0, 0, mxCreateDoubleScalar(8));
    ...
    mxSetFieldByNumber(plhs[1], 0, 3, fout);

    // NumObjects
    mxSetFieldByNumber(plhs[1], 0, 2, mxCreateDoubleScalar(n));
}
