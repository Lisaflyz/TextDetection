...
p = expResult.prms;
writeLog(sprintf('%s R:%2.2f%% P:%2.2f%% H:%2.2f%% sw:%.2f d:%.2f c:%.2f thr:%.2f-%.2f,%.2f,%.2f-%.2f' ...
        ,p.date,t13r*100,t13p*100,t13h*100,p.sw_ratio,p.distance_ratio,p.color_diff, ...
        p.clfthr,p.maxthr,p.maxthr2,p.maxthr3,p.finalthr));
